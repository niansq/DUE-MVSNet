...
class BlendedMVSDataset(Dataset):
    ...
    def build_metas(self):
        ...
        for scan in self.scans:
            with open(os.path.join(self.root_dir, scan, scan, scan, "cams/pair.txt")) as f:
    ...
    def build_proj_mats(self):
        ...
        if self.root_dir.endswith('low_res') \
            or self.root_dir.endswith('low_res/'):
            img_w, img_h = 768, 576
        else:
        ...
        for scan in self.scans:
            ...
            for vid in self.ref_views_per_scan[scan]:
                proj_mat_filename = os.path.join(self.root_dir, scan,scan,scan,
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            img_filename = os.path.join(self.root_dir,scan,scan,
                                f'{scan}/blended_images/{vid:08d}.jpg')
            depth_filename = os.path.join(self.root_dir,scan,scan,
